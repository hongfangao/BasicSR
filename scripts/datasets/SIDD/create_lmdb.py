...
def create_lmdb_for_sidd():
    ...
    # HR images
    folder_path = 'datasets/SIDD/train/input/subs'
    lmdb_path = 'datasets/SIDD/train/input/subs.lmdb'
    img_path_list, keys = prepare_keys_sidd(folder_path)
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    # LRx2 images
    folder_path = 'datasets/SIDD/train/target/subs'
    lmdb_path = 'datasets/SIDD/train/target/subs.lmdb'
    img_path_list, keys = prepare_keys_sidd(folder_path)
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)
